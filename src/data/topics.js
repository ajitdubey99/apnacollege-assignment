export const topics = [
  ...
  { id: 'networks', name: 'Networks', pending: true, subtopics: [] }, 
  { id: 'mathematics', name: 'Mathematics', pending: true, subtopics: [] }, 
  { id: 'software-engineering', name: 'Software Engineering', pending: true, subtopics: [] }, 
  { id: 'web-development', name: 'Web Development', pending: true, subtopics: [] }, 
  { id: 'cloud-computing', name: 'Cloud Computing', pending: true, subtopics: [] }];
